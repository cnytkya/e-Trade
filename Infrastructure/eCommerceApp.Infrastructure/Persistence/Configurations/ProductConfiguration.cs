...
namespace eCommerceApp.Infrastructure.Persistence.Configurations
{
    public class ProductConfiguration : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            // YENİ EKLENEN RESİM ALANI KONFİGÜRASYONU
            builder.Property(p => p.ImageUrl)
                .IsRequired(false) // Resim URL'si nullable olduğu için zorunlu değil
                .HasMaxLength(250); // URL'ler için makul bir uzunluk belirledik

            //İlişkiler: Ürün üst kategoriye değil alt kategoriye ait olsun.
            builder.HasOne(p => p.Subcategory)
                .WithMany(p=>p.Products)
                .HasForeignKey(p=>p.SubcategoryId)
                .OnDelete(DeleteBehavior.Restrict);//Alt kategori silinirken ürünlerin silinmesini engelle.
