...
namespace eCommerceApp.Application.Service
{
    public class ProductService : IProductService
    {
        ...
        public async Task<(bool succedeed, IEnumerable<string> errors)> CreateProductAsync(CreateProductDto createProductDto, IFormFile imageFile)
        {
            ...
            // Controller'dan gelen dosya yolunu (string) Product modeline ata
            // Not: Resim yükleme ve dosya yolu oluşturma mantığı Controller'da olacak.
            // Bu kısım, Controller'da resim yüklendikten sonra ImageUrl'in DTO'ya atanmasıyla çalışacak.
