...
namespace eCommerceApp.Application.Interface.Services
{
    public interface IProductService
    {
        ...
        Task<(bool succedeed, IEnumerable<string> errors)> CreateProductAsync(CreateProductDto model, IFormFile imageFile);//Resim dosyasını (IFormFile) alacak metot imzası.
